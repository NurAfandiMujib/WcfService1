...
namespace WcfService1
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            string msg = "";
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-9BLFC43\\AFANDISQL;Initial Catalog=PatWcf;Persist Security Info=True;User ID=sa; Password=Nurafandi09");
            con.Open();
